...
export default async function PastPerformancePage() {
  ...
  if (db) {
    const [rawRecords, rawKpis, rawCustomers, rawCaseStudies, rawProducts] = await Promise.all([
        ...
        {caseStudies.length > 0 && (
          <section className="py-20 md:py-28 bg-white">
            <div className="container mx-auto px-4 md:px-6">
              ...
              <FeaturedCaseStudyCards studies={caseStudies} heading="Deployment Case Studies" maxVisible={3} showViewAll />
            </div>
          </section>
        )}
