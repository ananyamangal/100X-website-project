...
const SEED_OPPORTUNITIES: Partial<Opportunity>[] = [
  ...
  { title: "Google Search Console API integration", description: "Connect GSC to populate SEO Command Center with real keyword rankings, impressions, and CTR data.", module: "seo", source: "manual", businessValue: "high", seoValue: "critical", geoValue: "low", dealerImpact: "low", effort: "medium" },
