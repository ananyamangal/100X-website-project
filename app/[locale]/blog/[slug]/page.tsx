      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="max-w-3xl mx-auto">
          <article>
            ...
            {/* Main content */}
            {content ? (
              <div className="blog-body text-base md:text-[1.0625rem] text-gray-800 leading-[1.8] space-y-5 overflow-x-hidden [overflow-wrap:anywhere] [word-break:break-word] [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-gray-900 [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-gray-900 [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:mb-4 [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:pl-6 [&_ol]:space-y-2 [&_li]:leading-relaxed [&_strong]:font-semibold [&_strong]:text-gray-900 [&_a]:text-brand-700 [&_a]:underline [&_a]:underline-offset-2 [&_a:hover]:text-brand-600 [&_a]:[word-break:break-all] [&_blockquote]:border-l-4 [&_blockquote]:border-green-500 [&_blockquote]:pl-5 [&_blockquote]:text-gray-600 [&_blockquote]:italic [&_blockquote]:my-6 [&_pre]:overflow-x-auto [&_pre]:max-w-full [&_code]:max-w-full [&_code]:[word-break:break-all] [&_table]:w-full [&_table]:overflow-x-auto [&_table]:block [&_table]:max-w-full [&_img]:max-w-full [&_img]:h-auto [&_iframe]:max-w-full [&_iframe]:w-full">
