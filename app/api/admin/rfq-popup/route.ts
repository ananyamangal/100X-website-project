...
export async function PUT(request: NextRequest) {
  try {
    ...
    const config = {
      ...
      neverAfterSubmission: body.neverAfterSubmission !== false,
      ...
      notificationWhatsapp: typeof body.notificationWhatsapp === "string" ? body.notificationWhatsapp : "",
      notificationWebhook: typeof body.notificationWebhook === "string" ? body.notificationWebhook : "",
      allowFileUpload: Boolean(body.allowFileUpload),
      maxFileSizeMb: typeof body.maxFileSizeMb === "number" ? Math.max(1, body.maxFileSizeMb) : 5,
      allowedFileTypes: Array.isArray(body.allowedFileTypes) ? body.allowedFileTypes : DEFAULT_CONFIG.allowedFileTypes,
