  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-gray-50 pt-24 pb-16">
      ...
      <div className="container mx-auto max-w-2xl px-4">
        <div className="rounded-2xl border border-brand-100 bg-white p-8 shadow-xl md:p-12">
          ...
          <div className="mt-10 space-y-4 border-t border-gray-100 pt-8">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <a href="tel:+917827229116" className="font-medium text-brand-700 hover:underline">
                    {BUSINESS.phonePrimary}
                  </a>
                  <span className="text-gray-500"> · </span>
                  <a href="tel:+918178567520" className="font-medium text-brand-700 hover:underline">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="border-brand-600 text-brand-700 hover:bg-brand-50">
