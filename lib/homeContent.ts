  ...
  try {
    ...
    return {
      ...
      technology: {
        ...d.technology,
        ...(doc.technology ?? {}),
        steps: Array.isArray(doc.technology?.steps) && doc.technology.steps.length > 0
          ? doc.technology.steps
          : d.technology.steps,
        benefits: Array.isArray(doc.technology?.benefits) && doc.technology.benefits.length > 0
      ...
      manufacturingAuthority: {
        ...
        stats: Array.isArray(doc.manufacturingAuthority?.stats) && doc.manufacturingAuthority.stats.length > 0
