...
export const PERMISSION_REGISTRY: PermDef[] = [
  ...
  { key: "procurement.enrichment.approve",   label: "Approve Enrichment Runs", description: "Issue approval tokens for enrichment operations — possession of batch_collect.run alone is insufficient", group: "Procurement Submodules", subgroup: "Enrichment Control", module: "procurement", action: "approve", critical: true, sortOrder: 3305 },
  { key: "procurement.archive.view",  label: "View Contract Archive",  description: "Browse and view archived contract PDFs and metadata",                                                             group: "Procurement Submodules", subgroup: "Archive",            module: "procurement", action: "view",   critical: true, sortOrder: 3310 },
  { key: "procurement.archive.write", label: "Archive Contracts",      description: "Write contracts to the PDF archive — requires approval token; max 10 contracts per run; Fogging Machine only", group: "Procurement Submodules", subgroup: "Archive",            module: "procurement", action: "run",    critical: true, sortOrder: 3311 },
...
export const PERMISSIONS = {
  ...
  PROCUREMENT_ENRICHMENT_APPROVE: "procurement.enrichment.approve",
  PROCUREMENT_ARCHIVE_VIEW:  "procurement.archive.view",
  PROCUREMENT_ARCHIVE_WRITE: "procurement.archive.write",
...
export const MODULE_PERMISSIONS: Record<string, string> = {
  // FOUNDER
  "/admin/growth/director":            "dashboard.view",
  "/admin/growth/dashboard":           "dashboard.view",
  "/admin/growth/operations":          "dashboard.view",
  "/admin/growth/reports":             "reports.view",
  // MARKETING
  "/admin/growth/ads":                 "ads.view",
  "/admin/growth/ads/director":        "ads.view",
  "/admin/growth/ads/creative-director": "ads.view",
  ...
  "/admin/growth/seo/offpage":         "seo.view",
  "/admin/growth/seo/offpage/validate": "seo.view",
  ...
  // MARKET INTELLIGENCE
  "/admin/growth/fogging":             "procurement.view",
  ...
  // SYSTEM
  "/admin/growth/security":            "dashboard.view",
  ...
  "/admin/growth/founder":             "dashboard.view",
}
