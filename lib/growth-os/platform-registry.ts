...
export const PLATFORM_VERSION = "v3.2"
...
export const CAPABILITY_REGISTRY: Capability[] = [
  ...
  },
  {
    ...
    category: "google_ads",
    status: "active",
    description: "GAQL metrics sync, CTR traffic-light dashboard (green >5%, yellow 2–5%, red <2%), auto-recommendations engine.",
    route: "/admin/growth/ads/monitoring",
    api: "/api/admin/growth/ads/monitoring",
    collections: ["ads_campaign_metrics", "ads_optimization_recommendations"],
    trigger: "Manual sync; daily recommended",
    output: "Campaign health metrics + ranked optimization recs",
    usedBy: "Founder / Marketing",
  },
  {
    id: "growth-os-diagnostics",
    name: "Growth OS Diagnostics",
    category: "google_ads",
    status: "active",
    description: "Master health check classifying 10 systems as VERIFIED / PARTIALLY_VERIFIED / UNVERIFIED / BROKEN. Includes conversion label config form and GTM JSON regenerator.",
    route: "/admin/growth/diagnostics",
    api: "/api/admin/growth/diagnostics",
    trigger: "On-demand",
    output: "System classification report with root-cause issues and actionable fixes",
    usedBy: "Founder",
  },
  {
