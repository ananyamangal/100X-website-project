...
export const HOMEPAGE_SECTIONS: SectionDef[] = [
  ...
  },
  {
    key: 'gov_supplies',
    pageKey: 'homepage',
    type: 'gov_supplies_grid',
    label: 'Featured Government Supplies',
    description: 'Past performance cards showing recent government procurement orders — builds trust on homepage',
    icon: '📋',
    defaultOrder: 103,
    defaultVariant: 'card-grid',
    defaultHeading: 'Featured Government Supplies',
    defaultSubheading: 'A sample of government procurement orders fulfilled for municipalities, health departments, and institutions across India.',
    defaultEyebrow: 'Track Record',
    defaultBgColor: 'gray',
    isDynamic: true,
    variants: [
      { key: 'card-grid', label: 'Card Grid', description: '3-column grid of past performance cards' },
    ],
    fields: [
      { key: 'heading',    label: 'Section Heading', type: 'text' },
      { key: 'subheading', label: 'Subheading',      type: 'text' },
  ...
  },
  {
    key: 'gov_performance',
    pageKey: 'homepage',
    type: 'gov_kpi_snapshot',
    label: 'Government Performance Snapshot',
    description: 'Animated KPI counters + links to past performance and government procurement page',
    icon: '🏛',
    defaultOrder: 105,
    defaultVariant: 'counters',
    defaultHeading: 'Government Supply Performance',
    defaultSubheading: 'Trusted by government departments, municipal bodies, and public institutions across India.',
    defaultEyebrow: 'Track Record',
    defaultBgColor: 'gray',
    isDynamic: true,
    variants: [
      { key: 'counters', label: 'KPI Counters', description: 'Animated number counters with links' },
    ],
    fields: [
      { key: 'heading',    label: 'Section Heading', type: 'text' },
      { key: 'subheading', label: 'Subheading',      type: 'text' },
  ...
  },
  {
    key: 'gov_success',
    pageKey: 'homepage',
    type: 'gov_case_studies',
    label: 'Government Success Stories',
    description: 'Showcase 3 published case studies from government deployments to build trust on the homepage',
    icon: '🏆',
    defaultOrder: 107,
    defaultVariant: 'card-grid',
    defaultHeading: 'Government Success Stories',
    defaultSubheading: 'Real fogging machine deployments with Indian government organizations and public institutions.',
    defaultEyebrow: 'Government Deployments',
    defaultBgColor: 'gray',
    isDynamic: true,
    variants: [
      { key: 'card-grid', label: 'Card Grid', description: 'Image + title + industry 3-column grid' },
    ],
    fields: [
      { key: 'heading',    label: 'Section Heading', type: 'text' },
      { key: 'subheading', label: 'Subheading',      type: 'text' },
  ...
  },
  {
    key: 'deployments',
    pageKey: 'homepage',
    type: 'deployments_gallery',
    label: 'Real World Deployments',
    description: 'Photo gallery of field installations — shown only if deployment images exist in DB',
    icon: '📸',
    defaultOrder: 109,
    defaultVariant: 'card-grid',
    defaultHeading: 'Real World Deployments',
    defaultSubheading: 'Visual proof — real installations and field operations across India.',
    defaultEyebrow: 'From the Field',
    defaultBgColor: 'white',
    isDynamic: true,
    variants: [
      { key: 'card-grid', label: 'Card Grid', description: '4-column image cards with location + department' },
    ],
    fields: [
      { key: 'heading',    label: 'Section Heading', type: 'text' },
      { key: 'subheading', label: 'Subheading',      type: 'text' },
