  ...
  return (
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="rounded-3xl bg-gradient-to-br from-green-600 to-green-700 px-6 py-10 md:px-12 md:py-14 shadow-xl text-white [[data-theme=dark-industrial]_&]:from-green-500 [[data-theme=dark-industrial]_&]:to-green-700">
          <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-base font-semibold text-green-700 shadow-sm transition-colors hover:bg-green-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-green-600"
              >
                {band.primary.label}
              </Link>
              {band.secondary ? (
