...
export default function HeroBlock({ heroSlides }: Props) {
  ...
  const mobileLqip = cloudinaryLqip(pickMobileSrc(currentSlideData))
      ...
      >
        <div className="absolute inset-0 touch-pan-y cursor-grab active:cursor-grabbing" {...swipeHandlers("ltr")}>
          <Image
            ...
            style={{ objectPosition: `${desktopFocalX}% ${desktopFocalY}%`, backgroundImage: `url("${desktopLqip}")`, backgroundSize: "cover" }}
          />
          <div
