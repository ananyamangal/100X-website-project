...
const T = {
  light: {
    ...
    cta: "bg-green-600 text-white hover:bg-green-700 shadow-md",
    ctaAlt: "border-2 border-green-600 text-green-700 hover:bg-green-50",
    ...
    goodBg: "bg-green-50 border border-green-100",
    goodText: "text-green-800",
    goodIcon: "text-green-600",
  },
  dark: {
    section: "bg-gray-900",
    headline: "text-white",
    ...
    cta: "bg-green-500 text-white hover:bg-green-400 shadow-lg",
    ...
    goodBg: "bg-green-900/30 border border-green-700/30",
    goodText: "text-green-300",
    goodIcon: "text-green-400",
  },
  green: {
    section: "bg-gradient-to-br from-green-700 via-green-800 to-green-900",
    headline: "text-white",
    sub: "text-green-200",
    body: "text-green-100",
    badge: "bg-white/15 text-white border border-white/20",
    cta: "bg-white text-green-800 hover:bg-green-50 shadow-lg",
    ctaAlt: "border-2 border-white/40 text-white hover:border-white",
